...
var templatePaths = map[string]string{
	"/opt/homebrew/Cellar/go/1.24.2/libexec/src/text/template":     "go_templates/text/template",
	"/opt/homebrew/Cellar/go/1.24.2/libexec/src/html/template":     "go_templates/html/template",
...
var replacements = []importReplacement{
	// Imports
	{`"text/template/parse"`, `"wispy-core/go_templates/text/template/parse"`},
	{`"text/template"`, `"wispy-core/go_templates/text/template"`},
	{`"html/template"`, `"wispy-core/go_templates/html/template"`},
	{`"internal/fmtsort"`, `"wispy-core/go_templates/internal/fmtsort"`},
	{`"internal/testenv"`, `"wispy-core/go_templates/internal/testenv"`},
	{`"internal/cfg"`, `"wispy-core/go_templates/internal/cfg"`},
	{`"internal/goarch"`, `"wispy-core/go_templates/internal/goarch"`},
	{`"internal/platform"`, `"wispy-core/go_templates/internal/platform"`},
	{`"internal/diff"`, `"wispy-core/go_templates/internal/diff"`},
	{`"internal/txtar"`, `"wispy-core/go_templates/internal/txtar"`},
	// Other replacements
